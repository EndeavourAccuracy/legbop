...
The legbop website can be found at [ https://github.com/EndeavourAccuracy/legbop ].
...
The above license is only for legbop itself; its source code and its images.
...
Ed Magnin, the programmer of the GBC port, gave me some helpful suggestions.

David (Princed), created the Game Boy (Color) wiki page in December 2016.

===[5 - FEEDBACK]==============================================================

If legbop crashes, gets compilation errors or crashes while building, send an e-mail to [ nlmdejonge@gmail.com ]. Make sure to describe exactly what actions triggered the bug and the precise symptoms of the bug. If possible, also include: 'uname -a', 'gcc -v', 'sdl2-config --version', and 'legbop --version'.
...
Copy the Dev-Cpp/MinGW64/i686-w64-mingw32/bin/*.dll files to the legbop directory.
...
C Project
Name: legbop
Save legbop.dev to the legbop directory.
...
Browse and add: png/various/legbop_icon.ico
